    ...
    <div className="bg-gray-50 dark:bg-neutral-900" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          Want to contact us? Please send us a message and we will get back to you within 24 hours
        </p>
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          <h2 className="text-lg font-bold">Contact V. R. Varma</h2>
          ...
          <div className="flex items-center mt-8 space-x-2 text-dark-600 dark:text-neutral-400">
            ...
            <span>V. R. Varma , Surat, Gujarat 395009</span>
          </div>

          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
            <EnvelopeIcon className="w-4 h-4" />
            <a href="mailto:fsovasudev@gmail.com">fsovasudev@gmail.com</a>
          </div>

          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
            <PhoneIcon className="w-4 h-4" />
            <a href="tel:9428822335">+91 9428822335</a>
          </div>
        </div>
        ...
        <div>
          {!isSubmitSuccessful && (
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <input type="hidden" value="Website ContactForm" {...register("from_name")} />
              <input
                type="checkbox"
                id=""
                className="hidden"
              ...
              <button
                type="submit"
                className="w-full py-4 font-semibold text-white transition-colors bg-amber-500 rounded-md hover:bg-neutral-800 focus:outline-none focus:ring-offset-2 focus:ring focus:ring-neutral-200 px-7 dark:bg-white dark:text-black "
              >
                {isSubmitting ? (
                  <svg
                    className="w-5 h-5 mx-auto text-white dark:text-amber-400 animate-spin"
